  ...
  if (auth?.user?.userType === "admin") {
    ...
    content =
      userNotifications.length > 0
        ? userNotifications.slice(0, 4).map((notify) => {
            return (
              <p
                key={notify.id}
                className="my-3 flex"
                ...
                <MenuHandler>
                  <Button className="p-2 bg-transparent shadow-none">
                    <div className="bg-blue-100 px-2 rounded-sm py-2 relative">
                      ...
                      <p className="absolute -top-2 left-3/4 border circle px-1 text-white text-xs bg-primary">
                        {count}
                      </p>
                    </div>
                  </Button>
            ...
            <div className="ml-5">
              <Menu placement="bottom-end">
                ...
                <MenuList>
                  ...
                  <MenuItem onClick={() => navigate("/dashboard/meetings")}>
                    Meetings
                  </MenuItem>
