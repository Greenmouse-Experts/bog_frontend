        ...
        <div className="w-full py-8 bg-white px-4 lg:flex justify-between items-center">
          <div>
            ...
            <p className="fs-400 text-gray-600 mt-2">
              subscribe to gain access to all services.
            </p>
          ...
          {plans.length > 0 && user ? (
            <div className="bg-white ">
              <div className="text-center pt-6 lg:pt-12">
                <p className="text-2xl fw-600">
                  <span className="text-primary">Flexible </span>Plans
                </p>
                <p className="mt-3 text-gray-600 lg:w-96 mx-auto">
          ...
          >
            <div className="flex justify-between px-4 py-6">
              <p className="lg:fs-700 fw-500 flex">
                ...
                <span>
                  Please note that you are to complete and submit your KYC form
                  before proceeding with your choiced subscription.
                </span>
              </p>
            </div>
