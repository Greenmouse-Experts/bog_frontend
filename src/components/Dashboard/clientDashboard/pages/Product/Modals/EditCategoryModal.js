...
import { updateCategory } from "../../../../../../redux/actions/ProductAction";
import { categorySchema } from "../../../../../../services/validation";
import Spinner from "../../../../../layouts/Spinner";

const EditCategoryModal = ({ CloseModal, itemDetails }) => {
    ...
    >
      ...
      >
        <form onSubmit={formik.handleSubmit}>
          <p className="lg:fs-700 fw-600">Edit Category</p>
          <div className="mt-5">
          ...
          <div className="mt-5">
            <label className="block">Category Measurement (Unit)</label>
            <input
              type="text"
              className="w-full border border-gray-400 rounded mt-2 py-2 px-2"
              required
