...
export default function ProjectDetailsPartner() {
    ...
    const serviceUpdate = update.filter(where => where.by === "service_partner")
    const CloseModal = () => {
    ...
    return (
                        ...
                        <div>
                            ...
                            <div className="bg-white lg:p-6 p-3 mt-8 rounded-md">
                                <div className="flex justify-between border-b border-gray-300 pb-4">
                                    ...
                                    <BiEdit onClick={() => setUpdateModal(true)} className='text-primary'/>
                                </div>
                                <div>
                                {
                        ...
                        <div>
                            <div className="bg-white lg:p-6 p-3 mt-8 rounded-md">
                                <div className="flex justify-between border-b border-gray-300 pb-4">
                                    ...
                                    <BiEdit onClick={() => setProgressModal(true)} className='text-primary'/>
                                </div>
                                <div className="flex flex-col mt-6">
                                    <Progress value={project?.service_partner_progress? project?.service_partner_progress : 0} color={returnColor(project?.service_partner_progress? project?.service_partner_progress : 0)} />
        ...
        {
            progressModal && (
                <PartnerProgress CloseModal={CloseModal} getProjectDetail={getProjectDetail} project={project} id={project.id}/>
            )
        }
        {
            updateModal && (
                <PartnerUpdates CloseModal={CloseModal} getUpdates={getUpdates} project={project}/>
            )
        }
    </div>
    )
