      ...
      {moreDetails && (
        <div className="">
          <div className="p-8 bg-white flex shadow-md">
            <p className="fw-600 lg:text-xl">Transaction Id :</p>
            <p className="text-primary lg:text-xl pl-4 fw-600">
              {item.TransactionId}
            </p>
          </div>
            ...
            <div className="p-6 bg-white shadow-md">
              ...
              <div className="mt-6">
                ...
                <div className="border-b py-2 flex">
                  ...
                  <p className="w-8/12">
                    {dayjs(item?.createdAt).format("hh:mma DD-MMM-YYYY")}
                  </p>
                </div>
                <div className="border-b py-2 flex">
                ...
                {item?.type !== "Subscription" &&
                  (item?.type === "Projects" ? (
                    <div className="border-b py-2 flex">
                      <p className="fw-500 w-4/12">Project ID:</p>
                      <p className="w-8/12"> {details?.projectSlug}</p>
                    </div>
                  ) : (
                    <div className="border-b py-2 flex">
                      <p className="fw-500 w-4/12">Order ID:</p>
                      <p className="w-8/12"> {details?.orderSlug}</p>
                    </div>
                  ))}
                <div className="border-b py-2 flex">
                ...
                <div className="border-b py-2 flex">
                  ...
                  <p className="w-8/12">
                    {item?.user?.fname
                      ...
                      : details?.user.service_user
                      ? details?.user.service_user.name
                      : ""}
                  </p>
                </div>
                <div className="border-b py-2 flex">
                  <p className="fw-500 w-4/12">{item?.type} Date:</p>
                  <p className="w-8/12"> {dayjs(details?.createdAt).format('hh:mma DD-MMM-YYYY')}</p>
                </div>
                <div className="border-b py-2 flex">
                  ...
                  <p className="w-8/12">
                    {item?.user?.email
                      ? item?.user?.email
                      : details?.user.service_user
                      ? details?.user.service_user.email
                      : ""}
                  </p>
                </div>
                <div className="border-b py-2 flex">
