    ...
    <div className="mt-8">
      {loading ? (
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="w-full mt-6">
            ...
            {passTooltip && (
              <div
                className="flex scale-ani py-2 px-2 my-2 bg-tool rounded fs-300"
                onClick={() => setPassTooltip((prev) => !prev)}
              >
                <AiOutlineInfoCircle className="text-lg text-gray-700" />
                <p className="pl-2">
                  The password must contain minimum of 8 characters, uppercase
                  character and a unique character
                </p>
              </div>
            )}
          ...
          <div className="w-full mt-6">
            <div className="flex justify-between pr-2">
              ...
              <AiOutlineInfoCircle
                ...
                onClick={() => setRefTooltip((prev) => !prev)}
              />
            </div>
            {refTooltip && (
              <div className="flex scale-ani py-2 px-2 my-2 bg-tool rounded fs-300">
                <AiOutlineInfoCircle className="text-lg text-gray-700" />
                <p className="pl-2">
                  Please, only enter the referral. Leave empty if you dont have
                  a referral code.
                </p>
              </div>
            )}
          ...
          <div className="mt-8 w-11/12 flex">
            ...
            <p className="px-2">
              I agree to the
              <Link to="/terms">
                <span className=" pl-2 text-primary hover:text-red-600 cursor-pointer  ">
                  Terms & Conditions
                </span>
              </Link>
              .
      ...
      <div className="w-full mt-12">
        <div className="relative">
          <p className="w-12 text-center mx-auto bg-white relative z-10 text-lg">
            OR
          </p>
        ...
        <div className="lg:grid grid-cols-2 gap-x-6 px-8 lg:px-4 mt-8 ">
          <div
            className="mt-4 flex cursor-pointer items-center justify-evenly border py-2 rounded-lg shadow"
            onClick={() => login()}
          >
      ...
      <div className="mt-10">
        ...
        <Link to="/login">
          <span className="text-primary fw-600 fs-500 pl-2">Login</span>
        </Link>
      </div>
    </div>
  );
