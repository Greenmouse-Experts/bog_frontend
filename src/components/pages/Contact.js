  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_URL}/user/contact-admin`,
        paylaod
      );
      ...
      <div>
        ...
        <div className="bg-contact bg-cover bg-center text-white h-44 lg:h-80 flex items-center">
          <div className="box">
            ...
            <p>
              Reach out to us to concerning informations, feedbacks and inquiry
            </p>
          </div>
        </div>
            ...
            <div className="lg:bg-light py-4  lg:flex justify-around mt-8">
              ...
              <div className="lg:w-3/12 text-center relative pt-8 mt-20 lg:mt-0">
                ...
                <p className="w-8/12 m-auto">
                  13, Olufunmilola Okikiolu Street, Off Toyin Street, Ikeja,
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="lg:flex">
                      <div className="lg:mr-3">
                        ...
                        <input
                          ...
                          className="w-full border rounded border-gray-500 py-1 px-2 mt-2 "
                        />
                      </div>
                    ...
                    <div className="mt-6">
                      ...
                      <textarea
                        ...
                        value={message}
                        onChange={formik.handleChange}
                        className="w-full border rounded border-gray-500 mt-2 px-2 py-2"
                        rows={5}
                      />
                    </div>
