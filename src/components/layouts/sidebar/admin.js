          ...
          <div className="">
            ...
            {user?.level === 1 ? (
              ...
              >
                ...
                {userDrop && (
                  <div
                    className="lg:pl-8 pl-4 fs-400 pt-2"
            ...
            {user?.level === 1 || user?.level === 4 ? (
              <>
                <NavLink
                  ...
                  style={({ isActive }) => (isActive ? activeStyle : undefined)}
                >
                  <VscRocket className="text-xl" />
                  <p className="pl-3">Delivery Addresses</p>
                </NavLink>
              </>
            ) : (
              ""
              ...
              >
                ...
                {settingsDrop && (
                  <div
                    ...
                    onClick={(e) => e.stopPropagation()}
                  >
                    <NavLink to="settings" onClick={unShow}>
                      <p className="pb-2">Profile Settings</p>
                    </NavLink>
                    <NavLink to="smart-calc" onClick={unShow}>
                      <p className="py-1">Smart Calculator</p>
                    </NavLink>
                    <NavLink to="admin-sub" onClick={unShow}>
